...
function Login() {
  return (
    ...
    <div className="bg-blue-100 h-screen w-screen py-1">
      ...
      <div className="flex items-center justify-center flex-col md:flex-row bg-blue-50 shadow-lg rounded-lg overflow-hidden max-w-6xl mx-auto sm:my-10 md:my-60 lg:my-40 ">
