      ...
      <nav className='h-[10vh] w-full'>
        <div className='flex'>
          ...
          <div className='w-[20%] flex justify-center items-center gap-10 h-[10vh]'>
            <Link to='/Signup ' className='px-5 py-2 rounded-lg text-[1.34rem] text-[#015DFE] border-2 border-[#015DFE] font-semibold'>Sign-in</Link>
            <Link  to='/Login '  className='px-5 py-2 text-[1.34rem] bg-[#015DFE] text-white rounded-lg font-semibold'>Login</Link>
          </div>
        </div>
      </nav>
    </div>
